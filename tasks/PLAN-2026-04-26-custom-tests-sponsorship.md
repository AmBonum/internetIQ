...
| [E8.2](./stories/E8.2-builder-picker-ui.md) | `/test/zostav` composer UI (pack-preload + picker + threshold) | L | P2 | 🟡 Ready (E8.1 done) | E7.1 |
| [E8.3](./stories/E8.3-zostava-route.md) | `/test/zostava/$id` shareable composer set | S | P2 | ⛔ Blocked | E8.2 |
